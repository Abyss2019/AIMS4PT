...
| Figure | Main notebook |
| --- | --- |
| Figure 1 | `00_independent_dataset.ipynb` |
| Figure 2 | `03_reproduce_AIMS4PT_cpx_figures.ipynb` |
| Figure 3 | `03_reproduce_AIMS4PT_cpx_figures.ipynb` |
| Figure 4 | `03_reproduce_AIMS4PT_cpx_figures.ipynb` |
| Figure 5 | `00_independent_dataset.ipynb` |
| Figure 6 | `03_reproduce_AIMS4PT_cpx_figures.ipynb` |
| Figure 7 | `03_reproduce_AIMS4PT_cpx_figures.ipynb` |
| Figure 8 | `03_reproduce_AIMS4PT_cpx_figures.ipynb` |
| Figure 9 | `04_apply_AIMS4PT_cpx_to_Merapi.ipynb` |
| Figure 10 | `04_apply_AIMS4PT_cpx_to_Merapi.ipynb` |
