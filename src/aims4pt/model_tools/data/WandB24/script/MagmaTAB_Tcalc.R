...
if (model_select == "MeltMin"){
  y.data_train <- training[,c("T_C","ol","opx","cpx","plag","amph","ox","bt","ksp","gt","qz","SiO2.n.","TiO2.n.","Al2O3.n.","FeO.n.","MgO.n.","CaO.n.","Na2O.n.","K2O.n.")]
...
T_C <- initial_predictions
y.data_t <- cbind(y.data_test,T_C)
